  ...
  return (
    <div className="relative h-screen bg-black text-white overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center h-full space-y-6 z-10 relative">
        ...
        <button onClick={() => navigate("/dashboard")} // or close modal/logout
          className="mt-4 px-8 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-md text-lg font-medium transition">
          Get Started
